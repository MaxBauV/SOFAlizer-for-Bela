...
/**
* Inherited from Bela/libraries/Fft/Fft.cpp
* https://github.com/BelaPlatform/Bela/blob/master/libraries/Fft/Fft.cpp
*
* Changed to easily toggle between CPU & NEON implementations for FFT & IFFT
*/
...
{
	//TODO: memset 0
	#if FFT_METHOD == FFT_CPU
		ne10_fft_r2c_1d_float32_c(frequencyDomain, timeDomain, cfg);
	#else
...
{
	#if FFT_METHOD == FFT_CPU
		ne10_fft_c2r_1d_float32_c(timeDomain, frequencyDomain, cfg);
	#else
