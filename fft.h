...
/**
* Inherited from Bela/libraries/Fft/Fft.h
* https://github.com/BelaPlatform/Bela/blob/master/libraries/Fft/Fft.h
*/
...
public:
	...
	/**
	 * Get the frequency-domain representation at index
	 */
	ne10_fft_cpx_float32_t* fd(void) { return frequencyDomain; };
	/**
